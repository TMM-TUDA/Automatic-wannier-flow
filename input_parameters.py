...
def calc_type():
        ...
        SMART_SEARCH = True ## Searches and determines the progress of each directory. If set 'True', none of the previous tags is valid.
...
def hte_tags():
        ...
        ## MAGMOM is parallel to z axis by default. Set it appropriately for different directions
